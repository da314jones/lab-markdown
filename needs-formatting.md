...
![This is an image of a Racoon](https://curiodyssey.org/wp-content/uploads/bb-plugin/cache/Mammals-Raccoon-square.jpg)
...
```js
console.log("Talking racoons are not necessarily named Rocket.");
```